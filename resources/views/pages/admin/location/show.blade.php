...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Detail Lokasi</h1>
        <div>
            <a href="{{ route('admin.location.index') }}" class="btn btn-sm btn-soft-teal btn-pill btn-elevated">
                <i class="fas fa-arrow-left fa-sm mr-1"></i> Kembali
            </a>
            <a href="{{ route('admin.location.edit', $location->id) }}" class="btn btn-sm btn-soft-primary btn-pill btn-elevated">
                    ...
                    <div class="summary-grid">
                        <div class="summary-item">
                            ...
                            <div class="summary-content">
                                <div class="summary-label">Gedung/Area</div>
                                <div class="summary-value">{{ $location->location ?: '-' }}</div>
                            </div>
                        </div>
                        <div class="summary-item">
                            <div class="summary-icon bg-info text-white"><i class="fas fa-door-open"></i></div>
                            <div class="summary-content">
                                <div class="summary-label">Ruangan</div>
                                <div class="summary-value">{{ $location->room ?: '-' }}</div>
                            </div>
                        </div>
                        <div class="summary-item">
                            <div class="summary-icon bg-warning text-white"><i class="fas fa-layer-group"></i></div>
                            <div class="summary-content">
                                <div class="summary-label">Lantai</div>
                                <div class="summary-value">{{ $location->floor ?: '-' }}</div>
                            </div>
                        </div>
                    </div>
                </div>
