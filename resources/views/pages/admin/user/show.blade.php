...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            ...
            <a href="{{ route('admin.user.edit', $item->id) }}" class="btn btn-sm btn-soft-primary btn-pill btn-elevated">
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless">
                            <tbody>
                                ...
                                <tr>
                                    <th>Departemen</th>
                                    <td>{{ optional($item->departemen)->name ?? '-' }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="card-body p-3 summary-card-body">
                    <div class="summary-grid">
                        <div class="summary-item">
                            <div class="summary-icon bg-primary text-white"><i class="fas fa-user"></i></div>
                        ...
                        <div class="summary-item">
                            <div class="summary-icon bg-info text-white"><i class="fas fa-id-card"></i></div>
                            <div class="summary-content">
                                <div class="summary-label">NIP</div>
                                <div class="summary-value">{{ $item->nip ?: '-' }}</div>
                            </div>
                        </div>
                        <div class="summary-item">
                            <div class="summary-icon bg-success text-white"><i class="fas fa-envelope"></i></div>
                            <div class="summary-content">
                                <div class="summary-label">Email</div>
                                <div class="summary-value">{{ $item->email ?: '-' }}</div>
                            </div>
                        </div>
                        <div class="summary-item">
                            <div class="summary-icon bg-warning text-white"><i class="fas fa-briefcase"></i></div>
                            <div class="summary-content">
                                <div class="summary-label">Roles</div>
                                <div class="summary-value">{{ $item->roles ?: '-' }}</div>
                            </div>
                        </div>
                        <div class="summary-item">
                            <div class="summary-icon bg-secondary text-white"><i class="fas fa-building"></i></div>
                            <div class="summary-content">
                                <div class="summary-label">Departemen</div>
                                <div class="summary-value">{{ optional($item->departemen)->name ?? '-' }}</div>
                            </div>
                        </div>
                    </div>
                </div>
