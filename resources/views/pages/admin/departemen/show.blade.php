...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Detail Direktorat</h1>
        <div>
            <a href="{{ route('admin.departemen.index') }}" class="btn btn-sm btn-soft-teal btn-pill btn-elevated">
                <i class="fas fa-arrow-left fa-sm mr-1"></i> Kembali
            </a>
            <a href="{{ route('admin.departemen.edit', $item->id) }}" class="btn btn-sm btn-soft-primary btn-pill btn-elevated">
        ...
        <div class="col-xl-8 col-lg-8">
            <div class="card shadow mb-4 card-soft">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Informasi Direktorat</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-borderless">
                            <tbody>
                                <tr>
                                    <th style="width: 30%">Nama Direktorat</th>
                                    <td>{{ $item->name }}</td>
                                </tr>
                                <tr>
                                    <th>Deskripsi</th>
        ...
        <div class="col-xl-4 col-lg-4">
            <div class="card shadow mb-4 summary-card">
                <div class="card-header py-3 d-flex align-items-center justify-content-between">
                    ...
                    <span class="badge badge-secondary">Direktorat</span>
                </div>
                    ...
                    <div class="summary-grid">
                        <div class="summary-item">
                            ...
                            <div class="summary-content">
                                <div class="summary-label">Nama Direktorat</div>
                                <div class="summary-value">{{ $item->name ?: '-' }}</div>
                            </div>
                        </div>
                        <div class="summary-item">
                            <div class="summary-icon bg-info text-white"><i class="fas fa-align-left"></i></div>
                            <div class="summary-content">
