    ...
    <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Direktorat</h1>
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4 card-soft">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Daftar Direktorat</h6>
                                    <div class="header-actions d-flex align-items-center">
                                        <a href="{{ route('admin.departemen.create') }}" class="btn btn-sm btn-soft-primary btn-pill btn-elevated mr-2">
                                            <i class="fas fa-plus mr-1"></i> Tambah
                                        </a>
                                        <div class="dropdown">
                                            <a class="btn btn-sm btn-soft-teal btn-pill btn-elevated dropdown-toggle" href="#" role="button" id="depExportMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <i class="fas fa-file-export mr-1"></i> Ekspor
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in export-menu" aria-labelledby="depExportMenu">
                                                <div class="export-menu__header">
                                                    <div class="export-menu__title">Pilih Format</div>
                                                </div>
                                                <a class="dropdown-item export-item" href="#" id="btn-dep-export-excel">
                                                ...
                                                <a class="dropdown-item export-item" href="#" id="btn-dep-export-pdf">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive soft-table-wrapper">
                                        <table id="departemenTable" class="table table-hover align-middle soft-table" style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th width="5%">No</th>
