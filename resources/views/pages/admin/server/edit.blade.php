...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800">Edit Server</h1>
        </div>
        ...
        <div class="col-12">
            <div class="card mb-4 card-soft">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.server.update', $item->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('no_rack') is-invalid @enderror" id="no_rack" name="no_rack" value="{{ old('no_rack', $item->no_rack) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('rack_unit') is-invalid @enderror" id="rack_unit" name="rack_unit" value="{{ old('rack_unit', $item->rack_unit) }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('brand') is-invalid @enderror" id="brand" name="brand" value="{{ old('brand', $item->brand) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('model') is-invalid @enderror" id="model" name="model" value="{{ old('model', $item->model) }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('serial_number') is-invalid @enderror" id="serial_number" name="serial_number" value="{{ old('serial_number', $item->serial_number) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('application') is-invalid @enderror" id="application" name="application" value="{{ old('application', $item->application) }}" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('procurement_date') is-invalid @enderror" id="procurement_date" name="procurement_date" value="{{ old('procurement_date', optional($item->procurement_date)->format('Y-m-d')) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('acquition_date') is-invalid @enderror" id="acquition_date" name="acquition_date" value="{{ old('acquition_date', optional($item->acquition_date)->format('Y-m-d')) }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('status') is-invalid @enderror" id="status" name="status" required>
                                        @php($currentStatus = old('status', $item->status))
                                        <option value="" disabled {{ $currentStatus ? '' : 'selected' }}>Pilih status...</option>
